...
parser.add_argument("-a", "--play-with-alpha-beta", help='play with alpha beta and print every move.', action="store_true")
...
if args.learning_loop:
    ...
    play_with_human()
elif args.play_with_alpha_beta:
